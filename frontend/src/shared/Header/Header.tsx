...
import { logout, signUp } from '../../reducers/userReducer';

interface HeaderProps {
  ContainerStyle: string
}

export function Header({ContainerStyle} : HeaderProps) {
  const isAuth = useSelector((state: any) => state.user.isAuth)
  const userData = useSelector((data: any) => data.user.currentUser)
        ...
        <div className={styles.HeaderContainer}>
            ...
            <div className={styles.LogoContainer}>
              <span className={styles.LogoWrapper}>
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                  <g clipPath="url(#clip0_21502_116)">
            ...
            {isAuth &&
              <NavLink to='/statistics'>
                <div className={styles.HeaderButton}>
                  <svg className={styles.HeaderButtonIcon }xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <g clipPath="url(#clip0_21502_122)">
                      <path d="M10 20H14V4H10V20ZM4 20H8V12H4V20ZM16 9V20H20V9H16Z" />
                    </g>
                    <defs>
                      <clipPath id="clip0_21502_122">
          ...
          {!isAuth &&
            <NavLink to='/registration'>
              <div className={styles.HeaderLoginButton} onClick={handleSignedUp}>
                Зарегистрироваться
              </div>
            </NavLink>
          }
          {isAuth && <div className={styles.HeaderLoginButton} onClick={() => dispatch(logout())}>Выход</div>}
          </div>
        </div>
      </div>
    </header>
