...
import * as placeholderImg from '../../../img/tomato1.png'

export function Placeholder() {
  return (
    <div className={styles.Placeholder}>
      <div className={styles.MainContainer}>
        <svg xmlns="http://www.w3.org/2000/svg" width="215" height="215" viewBox="0 0 115 115" fill="none">
        ...
        <div className={styles.Wrapper}>
          <div className={styles.PlaceholderPretitle}>
            Вы пока не авторизованы
          </div>
          <div className={styles.PlaceholderTitle}>
            Войдите или зарегистрируйтесь, чтобы пользоваться Pomodoro
          </div>
        </div>
      </div>
    </div>
